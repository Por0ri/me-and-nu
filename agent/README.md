...
### 애니 · 유형 다섯 (`anime/anime_agent.py`, v0.2)
...
• 형태검사가 되풀이(문단 사이 14자 겹침 · 같은 숫자 다섯 번 · "~하면 된다" 넷)와 재료 옮겨 적기를 잡는다
...
python agent/py2ipynb.py agent/anime/anime_agent.py anime_agent_v0.2.ipynb     # 용어집이 노트북 안에 같이 들어간다
```
